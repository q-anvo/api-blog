...
namespace Illuminate\Testing {
    ...
    class TestResponse {
         ...
         * 
         *
         * @see \Spectator\Assertions::assertValidRequest()
         * @static 
         */
        public static function assertValidRequest()
        {
            return \Illuminate\Testing\TestResponse::assertValidRequest();
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::assertInvalidRequest()
         * @static 
         */
        public static function assertInvalidRequest()
        {
            return \Illuminate\Testing\TestResponse::assertInvalidRequest();
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::assertValidResponse()
         * @param int|null $status
         * @static 
         */
        public static function assertValidResponse($status = null)
        {
            return \Illuminate\Testing\TestResponse::assertValidResponse($status);
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::assertInvalidResponse()
         * @param int|null $status
         * @static 
         */
        public static function assertInvalidResponse($status = null)
        {
            return \Illuminate\Testing\TestResponse::assertInvalidResponse($status);
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::assertValidationMessage()
         * @param string $expected
         * @static 
         */
        public static function assertValidationMessage($expected)
        {
            return \Illuminate\Testing\TestResponse::assertValidationMessage($expected);
        }
         ...
         * @see \Spectator\Assertions::assertErrorsContain()
         * @static 
         */
        public static function assertErrorsContain($errors)
        {
            return \Illuminate\Testing\TestResponse::assertErrorsContain($errors);
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::assertPathExists()
         * @static 
         */
        public static function assertPathExists()
        {
            return \Illuminate\Testing\TestResponse::assertPathExists();
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::dumpSpecErrors()
         * @static 
         */
        public static function dumpSpecErrors()
        {
            return \Illuminate\Testing\TestResponse::dumpSpecErrors();
        }

        /**
         * 
         *
         * @see \Spectator\Assertions::runAssertion()
         * @param \Closure $closure
         * @static 
         */
        public static function runAssertion($closure)
        {
            return \Illuminate\Testing\TestResponse::runAssertion($closure);
        }
         ...
         * @see \Spectator\Assertions::collectExceptionMessages()
         * @static 
         */
        public static function collectExceptionMessages()
        {
            return \Illuminate\Testing\TestResponse::collectExceptionMessages();
        }
         ...
         * @see \Spectator\Assertions::expectsFalse()
         * @return void 
         * @static 
         */
        public static function expectsFalse($throwable = null, $exceptions = [])
        {
            \Illuminate\Testing\TestResponse::expectsFalse($throwable, $exceptions);
        }
         ...
         *
         * @param array<int, class-string> $exceptions
         * @see \Spectator\Assertions::expectsTrue()
         * @return void 
         * @static 
         */
        public static function expectsTrue($throwable = null, $exceptions = [], $message = '')
        {
            \Illuminate\Testing\TestResponse::expectsTrue($throwable, $exceptions, $message);
        }
